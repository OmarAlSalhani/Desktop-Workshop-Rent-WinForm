...
namespace app7.customers_forms
{
    public partial class ar_customers_paied_money_form : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            DataTable table = connection_class.select("select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where 1 = 2 ");
        ...
        void do_search(int query_status)
        {
            ...
            if (query_status == 1)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where customer_name=N'{customer_cb.Text}'");
            }
            if (query_status == 2)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where the_date between convert(date,'{f}',105) and convert(date,'{l}',105)");
            }
            if (query_status == 3)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where userID={userID}");
            }
            if (query_status == 4)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where customer_name=N'{customer_cb.Text}' and the_date between convert(date,'{f}',105) and convert(date,'{l}',105)");
            }
            if (query_status == 5)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where userID={userID} and the_date between convert(date,'{f}',105) and convert(date,'{l}',105)");

            }
            if (query_status == 6)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where userID={userID} and customer_name=N'{customer_cb.Text}'");

            }
            if (query_status == 7)
            {
                table = connection_class.select($"select id as 'الرمز',fatora_id as 'رقم الفاتورة',customer_name  as 'العميل',value as 'المبلغ المقبوض',convert(nvarchar,the_date,105) as 'تاريخ القبض',(select username from users_table where users_table.user_id=customers_paied_money_table.userID) as 'المستخدم' from customers_paied_money_table where customer_name=N'{customer_cb.Text}' and userID={userID} and the_date between convert(date,'{f}',105) and convert(date,'{l}',105)");
            }
