...
namespace app7.fatora_forms
{
  ...
  FROM [app7_database].[dbo].[sales_body_table] where fatora_id=" + fatora_id());
        ...
        int add_fatora_head_and_body(string bill_type, string customer_name)
        {
            ...
            GetFatoraID();
            ar_pos_uc.totalForPrint = (decimal)ar_sell_fatora_checkout_form.total_amount;
           ar_pos_uc.taxForPrint = (decimal)get_tax();
            ...
            TLVCls tlv = new TLVCls(settings_files.main_settings.Default.barber_name, settings_files.main_settings.Default.tax_number, DateTime.Now, ar_pos_uc.totalForPrint, ar_pos_uc.taxForPrint);
           ...
           ar_pos_uc.qr = pictureBox1.Image;
            ...
            logs_class.log_add($"New sales invoice with id {FatoraID}", FatoraID, "Sales");
            return result;
        }
        void clear_rows()
        {
        ...
        void set_storage_value_and_logs()
        {
            if (fatora_forms.ar_sell_fatora_checkout_form.cash_pay > 0)
            {
                ...
                storage_class.storage_log_add($"New sales invoice with id {FatoraID}", ar_sell_fatora_checkout_form.cash_pay, main_settings.Default.storage_id);
            }
            ...
            if (IsEveryThingOK())
            {
                ...
                if (fatora_forms.ar_sell_fatora_checkout_form.IsClicked)
                {
                    ...
                    if (customer_name_cb.Text == "Cash")
                    {
                        ...
                        SendFatoraToDatabase("Cash", customer_name_cb.Text);
                    }
        ...
        private void main_gridview_InvalidRowException(object sender, DevExpress.XtraGrid.Views.Base.InvalidRowExceptionEventArgs e)
        {
            ...
            OmarNotifications.Alert.ShowInformation("Please select product");
        }
        ...
        private void close_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                classes.form_close_class.close("en_pos_form");
            }
        }
    }
}
