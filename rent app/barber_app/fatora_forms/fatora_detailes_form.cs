...
namespace app7.fatora_forms
{
    public partial class fatora_detailes_form : DevExpress.XtraEditors.XtraForm
    {
       ...
       public static string invoice_number;
        ...
        {
            table = connection_class.select($"select product_name as 'المادة',quantity as 'الكمية',product_price_before_tax as 'السعر قبل الضريبة',tax as 'الضريبة',product_full_price as 'الأجمالي' from sales_body_table where fatora_id={invoice_number} "); ;
        }
