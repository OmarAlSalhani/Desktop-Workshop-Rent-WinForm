...
namespace app7
{
    public partial class en_login_form : Form
    {
        public en_login_form()
        {
        ...
        private void en_login_form_Load(object sender, EventArgs e)
        {
        ...
        bool is_everything_ok()
        {
            ...
            {
                OmarNotifications.Alert.ShowInformation("Please select username");
                return false;
            }
            if (texts_class.is_null(password_tb.Text))
            {
                OmarNotifications.Alert.ShowInformation("Please enter password");
                return false;
            }
            return true;
        }
        ...
        private void login_btn_Click(object sender, EventArgs e)
        {
            if (is_everything_ok())
            {
                ...
                {
                    OmarNotifications.Alert.ShowError("username or password invaild");
                    return;
                }
            }
        }
        ...
        private void permissions_worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            Hide();
            en_main_form form = new en_main_form();
            form.Show();
        }
        int progress;
