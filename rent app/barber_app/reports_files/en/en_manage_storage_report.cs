...
{
    public partial class en_manage_storage_report : DevExpress.XtraReports.UI.XtraReport
    {
        public en_manage_storage_report()
        {
            InitializeComponent();
        }
        public static void to_pdf(System.Data.DataTable products_datasource)
        {
            ...
            en_manage_storage_report report = new en_manage_storage_report();
