...
{
    public partial class en_manage_customers : DevExpress.XtraReports.UI.XtraReport
    {
        public en_manage_customers()
        {
            InitializeComponent();
        }
        public static void to_pdf(System.Data.DataTable products_datasource)
        {
            ...
            en_manage_customers report = new en_manage_customers();
