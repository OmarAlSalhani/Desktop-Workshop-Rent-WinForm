...
{
    public partial class en_customers_paied_money_report : DevExpress.XtraReports.UI.XtraReport
    {
        public en_customers_paied_money_report()
        {
            InitializeComponent();
        }
        public static void to_pdf(System.Data.DataTable products_datasource)
        {
            ...
            en_customers_paied_money_report report = new en_customers_paied_money_report();
